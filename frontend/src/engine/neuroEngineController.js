...
// 1. Usa IMPORT con .js
import { getSpotifyCandidates } from '../utils/recomendationSpotify.js'; // Tu motor viejo
import { translateFullSurvey } from './surveyNormalizer.js';
import { mapSongToVector } from './songNormalicer.js'; // Ojo con el nombre del archivo
import { rankCandidates } from './neuroEngine.js';
import { getAnalizedSong } from './getData.js'; // Tu fetcher
